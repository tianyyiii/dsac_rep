...
from relax.algorithm.sdac_rand_rep import SDACRandRep
...
from relax.network.sdac_rand_rep import create_sdac_rand_rep_net
...
if __name__ == "__main__":
    ...
    parser.add_argument("--alg", type=str, default="sdac_rand_rep")
    parser.add_argument("--env", type=str, default="dsac/pendulum-v0")
    parser.add_argument("--suffix", type=str, default="test_use_atp1")
    parser.add_argument("--num_vec_envs", type=int, default=5)

    parser.add_argument("--hidden_num", type=int, default=0)
    parser.add_argument("--hidden_dim", type=int, default=1024)
    parser.add_argument("--diffusion_hidden_num", type=int, default=2)
    parser.add_argument("--diffusion_hidden_dim", type=int, default=256)
    parser.add_argument("--feature_hidden_num", type=int, default=2)
    parser.add_argument("--feature_hidden_dim", type=int, default=256)
    ...
    assert args.alg == "sdac_rand_rep", "Only SDAC-Rand-Rep is supported in this script"

    def mish(x: jax.Array):
        return x * jnp.tanh(jax.nn.softplus(x))
    agent, params = create_sdac_rand_rep_net(init_network_key, obs_dim=obs_dim, act_dim=act_dim, feature_dim=args.feat_dim,
    ...
    algorithm = SDACRandRep(agent, params, lr=args.lr, alpha_lr=args.alpha_lr,
