...
from relax.algorithm.udiffrep import UDiffRep
...
from relax.network.udiffrep import create_sdac_rep_net
...
if __name__ == "__main__":
    ...
    parser.add_argument("--alg", type=str, default="udiff-rep")
    ...
    algorithm = UDiffRep(agent, params, lr=args.lr, alpha_lr=args.alpha_lr,
