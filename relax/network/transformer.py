...
class AddPositionEmbs(nn.Module):
    ...
    posemb_init: Callable[[jax.random.KeyArray, Shape, jax.typing.DTypeLike], jax.Array]
...
class MlpBlock(nn.Module):
    ...
    kernel_init: Callable[
        [jax.random.KeyArray, Shape, jax.typing.DTypeLike], jax.Array
    ] = nn.initializers.xavier_uniform()
    bias_init: Callable[[jax.random.KeyArray, Shape, jax.typing.DTypeLike], jax.Array] = nn.initializers.normal(
        stddev=1e-6
    )
