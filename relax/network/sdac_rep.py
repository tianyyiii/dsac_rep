...
from relax.network.blocks import Activation, FeatureNet, mlp, SDACRepDPhiDaNet, SDACRepPhiNet, SDACRepPolicyNet
from relax.network.sdac import SDACNet, Diffv2Params
from relax.utils.jax_utils import random_key_from_data
from typing import Union

class SDACRepParams(NamedTuple):
    # old
    q1: hk.Params
    q2: hk.Params
    target_q1: hk.Params
...
def create_sdac_rep_net(
    ...
    policy = hk.without_apply_rng(hk.transform(lambda feat: SDACRepPolicyNet(hidden_sizes, act_dim, activation)(feat)))
    feature = hk.without_apply_rng(hk.transform(lambda obs, act, t: SDACRepPhiNet(feature_hidden_sizes, feature_dim, activation)(obs, act, t)))
